# Projeto Fullstack + Mobile

Este repositório contém três projetos integrados:

- Backend: Java + Spring Boot (maven)
- Frontend: React 19 + TypeScript + Mantine
- Mobile App: Flutter


## 1. Ferramentas e versões instaladas
